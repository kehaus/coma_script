...
ax1.plot(1.8*np.sin(x), 0.8*np.cos(x), **line_style1)
...
xlabel = ax1.annotate('$T$', (0.90, 0.16), xycoords='figure fraction',
                      **font_dict_label)
ylabel = ax1.annotate('$|\psi|$', (0.12, 0.89), xycoords='figure fraction',
                      **font_dict_label)
...
fig1.savefig('../img/landauginzburg_psi_T.pdf', transparent=True)
