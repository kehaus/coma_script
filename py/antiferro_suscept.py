...
ax1.plot(x[400:], 0.255*x[400:]**-1, **line_style1)
ax1.plot([x[401], x[401]], [0, 0.255*x[400]**-1], '--k')
ax1.plot(x[:400], 0.231*x[:400]**2 + 0.6, **line_style1)
...
xlabel = ax1.annotate('T', (0.90, 0.16), xycoords='figure fraction',
                      **font_dict_label)
ylabel = ax1.annotate(r'$ \chi_{AFM} $', (0.20, 0.93), xycoords='figure fraction',
                      **font_dict_label)

# textboxes
txt1 = ax1.annotate(r'$ AFM $', (0.22, 0.20), xycoords='figure fraction', color='k',
                    **font_dict_txt)

txt2 = ax1.annotate(r'$ T_N $', (0.32, 0.18), xycoords='figure fraction', color='k',
                    **font_dict_txt)
txt3 = ax1.annotate(r'$ Paramagnetic $', (0.45, 0.20), xycoords='figure fraction', color='k',
                    **font_dict_txt)
...
fig1.savefig('../img/antiferro_suscept.pdf', transparent=True)
