...
A more sophisticated approach is provided by the Lindhard Theory from which the Thomas-Fermi screening is a special case ($\mathbf{q} \ll \mathbf{k}_0$).
...
\begin{equation} \label{eq_lindh_wf}
...
Plugging now our ansatz for $\psi$ into \refEq{eq_lindh_charge} leads to
